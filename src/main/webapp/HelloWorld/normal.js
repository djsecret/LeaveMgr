...
var gsOutOfRange = "对不起，不能超过设定的日期范围!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsBottom = "<a href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >今日 : " + gToday[0] + "年" + gMonths[gToday[1] - 1] + gToday[2] + "日</a>";	// the content of the bottom section.
